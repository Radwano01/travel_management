...
@Service
public class PackageRoadmapsRelationsServiceImpl implements PackageRoadmapsRelationsService {

    private final PackageRepository packageRepository;
    private final RoadmapRepository roadmapRepository;

    @Autowired
    public PackageRoadmapsRelationsServiceImpl(PackageRepository packageRepository,
