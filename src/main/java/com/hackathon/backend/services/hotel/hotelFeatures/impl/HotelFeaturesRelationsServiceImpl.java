...
@Service
public class HotelFeaturesRelationsServiceImpl implements HotelFeaturesRelationsService {
    ...
    @Autowired
    public HotelFeaturesRelationsServiceImpl(HotelFeaturesRepository hotelFeaturesRepository,
