...
class HotelEvaluationServiceTest {
    ...
    @BeforeEach
    void setUp() {
        hotelEvaluationService = new HotelEvaluationService(
                userUtils,
    ...
    void tearDown() {
        ...
        userUtils.deleteAll();
        hotelEvaluationUtils.deleteAll();
    }
    ...
    void editComment() {
        ...
        when(hotelEvaluationUtils.findById(commentId)).thenReturn(new HotelEvaluationEntity());
        //when
