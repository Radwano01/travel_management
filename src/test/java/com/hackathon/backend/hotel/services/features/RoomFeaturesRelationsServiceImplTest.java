...
class RoomFeaturesRelationsServiceImplTest {
    ...
    @InjectMocks
    private RoomFeaturesRelationsServiceImpl roomFeaturesRelationsServiceImpl;
    ...
    void addRoomFeatureToHotel_Success() {
        ...
        // when
        ResponseEntity<String> response = roomFeaturesRelationsServiceImpl.addRoomFeatureToHotel(hotelId, featureId);
    ...
    void removeRoomFeatureFromHotel_Success() {
        ...
        // when
        ResponseEntity<String> response = roomFeaturesRelationsServiceImpl.removeRoomFeatureFromHotel(hotelId, featureId);
