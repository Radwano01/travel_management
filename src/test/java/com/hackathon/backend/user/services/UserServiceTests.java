...
public class UserServiceTests {
    ...
    public void testRegisterUser_Success() {
        ...
        CompletableFuture<ResponseEntity<?>> response = userService.registerUser(dto);
    ...
    public void testLoginUser_Success() {
        ...
        CompletableFuture<ResponseEntity<?>> response = userService.loginUser(dto);
    ...
    public void testEditUserPassword_Success() {
        ...
        CompletableFuture<ResponseEntity<?>> response = userService.editUserPassword(userId, dto);
    ...
    public void testSendVerificationLink_Success() throws MessagingException {
        ...
        CompletableFuture<ResponseEntity<?>> response = userService.sendVerificationLink(userId, token);
