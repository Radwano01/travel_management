...
class CountryDetailsServiceImplTest {
    ...
    @InjectMocks
    private CountryDetailsServiceImpl countryDetailsServiceImpl;
    ...
    void getSingleCountryDetails_CountryExists_ReturnsCountryDetails() {
        ...
        //when
        ResponseEntity<GetCountryWithCountryDetailsDto> response = countryDetailsServiceImpl.getSingleCountryDetails(countryId);
    ...
    void getSingleCountryDetails_CountryDoesNotExist_ThrowsEntityNotFoundException() {
        ...
        //then
        assertThrows(EntityNotFoundException.class, () -> countryDetailsServiceImpl.getSingleCountryDetails(countryId));
        verify(countryRepository, times(1)).findCountryWithCountryDetailsByCountryId(countryId);
    }
    ...
    void editCountryDetails_ValidEdit_ReturnsUpdatedCountryDetails() {
        ...
        //when
        ResponseEntity<String> response = countryDetailsServiceImpl.editCountryDetails(countryId, editDto);
