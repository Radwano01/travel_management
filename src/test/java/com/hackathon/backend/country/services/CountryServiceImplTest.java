...
class CountryServiceImplTest {
    ...
    void createCountry() {
        ...
        // when
        ResponseEntity<String> response = countryServiceImpl.createCountry(createCountryDto);
    ...
    void getAllCountries() {
        ...
        // when
        ResponseEntity<List<GetCountryDto>> response = countryServiceImpl.getAllCountries();
    ...
    void editCountry() {
        ...
        // when
        ResponseEntity<String> response = countryServiceImpl.editCountry(countryEntity.getId(), editCountryDto);
    ...
    void editCountry_NoDataSent() {
        ...
        // when
        ResponseEntity<String> response = countryServiceImpl.editCountry(countryEntity.getId(), emptyEditCountryDto);
    ...
    void deleteCountry() {
        ...
        // when
        ResponseEntity<String> response = countryServiceImpl.deleteCountry(countryEntity.getId());
    ...
    void deleteCountry_CountryNotFound() {
        ...
        // then
        assertThrows(EntityNotFoundException.class, () -> countryServiceImpl.deleteCountry(1));
    }
}
