...
class PlaceDetailsServiceTest {
    ...
    void getSinglePlaceDetails() {
        ...
        ResponseEntity<GetPlaceDetailsDto> response = placeDetailsService.getSinglePlaceDetails(placeId);
    ...
    void editPlaceDetails() {
        ...
        // Call the method
        ResponseEntity<String> response = placeDetailsService.editPlaceDetails(placeId, editDto);
