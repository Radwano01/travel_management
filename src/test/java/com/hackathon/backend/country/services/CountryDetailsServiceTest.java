...
class CountryDetailsServiceTest {
    ...
    @BeforeEach
    void setUp() {
        countryDetailsService = new CountryDetailsService(countryDetailsUtils);
    }
    ...
    void getSingleCountryDetails() {
        ...
        when(countryDetailsUtils.findByCountryId(countryId)).thenReturn(countryDetails);
        ...
        assertEquals(countryDetails.getId(), countryDetailsDto.getId());
        assertEquals(countryDetails.getImageOne(), countryDetailsDto.getImageOne());
        assertEquals(countryDetails.getImageTwo(), countryDetailsDto.getImageTwo());
        assertEquals(countryDetails.getImageThree(), countryDetailsDto.getImageThree());
        assertEquals(countryDetails.getCountry().getCountry(), countryDetailsDto.getCountry());
    }
    ...
    void editCountryDetails() {
        ...
        CountryDetailsEntity existingCountryDetails = new CountryDetailsEntity();
        existingCountryDetails.setId(countryDetailsId);

        when(countryDetailsUtils.findById(countryDetailsId)).thenReturn(existingCountryDetails);
