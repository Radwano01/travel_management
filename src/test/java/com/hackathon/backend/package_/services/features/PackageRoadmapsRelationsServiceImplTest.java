...
class PackageRoadmapsRelationsServiceImplTest {
    ...
    @InjectMocks
    PackageRoadmapsRelationsServiceImpl packageRoadmapsRelationsServiceImpl;
    ...
    void addPackageRoadmap_ShouldAddRoadmapSuccessfully() {
        ...
        // when
        ResponseEntity<String> response = packageRoadmapsRelationsServiceImpl.addPackageRoadmap(packageId, roadmapId);
    ...
    void removePackageRoadmap_ShouldRemoveRoadmapSuccessfully() {
        ...
        // when
        ResponseEntity<String> response = packageRoadmapsRelationsServiceImpl.removePackageRoadmap(packageId, roadmapId);
