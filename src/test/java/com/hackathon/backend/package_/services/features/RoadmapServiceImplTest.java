...
class RoadmapServiceImplTest {
    ...
    void createRoadmap_ShouldReturnSuccess_WhenRoadmapIsValid() {
        ...
        // when
        ResponseEntity<String> response = roadmapServiceImpl.createRoadmap(createRoadmapDto);
    ...
    void getRoadmaps_ShouldReturnAllRoadmaps() {
        ...
        // when
        ResponseEntity<List<GetRoadmapDto>> response = roadmapServiceImpl.getRoadmaps();
    ...
    void editRoadmap_ShouldReturnSuccess_WhenRoadmapIsValid() {
        ...
        // when
        ResponseEntity<String> response = roadmapServiceImpl.editRoadmap(roadmapId, editRoadmapDto);
    ...
    void deleteRoadmap_ShouldReturnSuccess_WhenRoadmapExists() {
        ...
        // Act
        ResponseEntity<String> response = roadmapServiceImpl.deleteRoadmap(roadmapId);
