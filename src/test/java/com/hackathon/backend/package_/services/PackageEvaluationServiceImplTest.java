...
class PackageEvaluationServiceImplTest {
    ...
    @InjectMocks
    PackageEvaluationServiceImpl packageEvaluationServiceImpl;
    ...
    void addComment_ShouldAddComment_WhenAllDataIsProvided() {
        ...
        // when
        CompletableFuture<ResponseEntity<?>> responseFuture = packageEvaluationServiceImpl.addComment(packageId, userId, createPackageEvaluationDto);
    ...
    void getComments_ShouldReturnComments_WhenPackageExists() {
        ...
        // when
        CompletableFuture<ResponseEntity<?>> responseFuture = packageEvaluationServiceImpl.getComments(packageId);
        ResponseEntity<?> response = responseFuture.join();
    ...
    void editComment_ShouldUpdateComment_WhenValidDataIsProvided() {
        ...
        // when
        CompletableFuture<ResponseEntity<?>> responseFuture = packageEvaluationServiceImpl.editComment(packageId, commentId, editPackageEvaluationDto);
        ResponseEntity<?> response = responseFuture.join();
    ...
    void editComment_ShouldReturnBadRequest_WhenEmptyDataIsSent() {
        ...
        // when
        CompletableFuture<ResponseEntity<?>> responseFuture = packageEvaluationServiceImpl.editComment(packageId, commentId, emptyDto);
        ResponseEntity<?> response = responseFuture.join();
    ...
    void removeComment_ShouldDeleteComment_WhenValidDataIsProvided() {
        ...
        // when
        CompletableFuture<ResponseEntity<?>> responseFuture = packageEvaluationServiceImpl.removeComment(packageId, commentId);
        ResponseEntity<?> response = responseFuture.join();
