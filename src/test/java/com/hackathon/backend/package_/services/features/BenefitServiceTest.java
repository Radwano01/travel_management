...
class BenefitServiceTest {
    ...
    void createBenefit_ShouldReturnSuccess_WhenBenefitIsValid() {
        ...
        // when
        ResponseEntity<String> response = benefitService.createBenefit(createBenefitDto);
    ...
    void getBenefits_ShouldReturnAllBenefits() {
        ...
        // when
        ResponseEntity<List<GetBenefitDto>> response = benefitService.getBenefits();
    ...
    void editBenefit_ShouldReturnSuccess_WhenBenefitIsValid() {
        ...
        // when
        ResponseEntity<String> response = benefitService.editBenefit(benefitId, editBenefitDto);
    ...
    void deleteBenefit_ShouldReturnSuccess_WhenBenefitExists() {
        ...
        // when
        ResponseEntity<String> response = benefitService.deleteBenefit(benefitId);
