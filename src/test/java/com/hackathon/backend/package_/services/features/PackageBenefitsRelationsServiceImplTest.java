...
class PackageBenefitsRelationsServiceImplTest {
    ...
    @InjectMocks
    private PackageBenefitsRelationsServiceImpl packageBenefitsRelationsServiceImpl;
    ...
    void addPackageBenefit_ShouldReturnOk_WhenBenefitIsAdded() {
        ...
        // when
        ResponseEntity<String> response = packageBenefitsRelationsServiceImpl.addPackageBenefit(packageId, benefitId);
    ...
    void removePackageBenefit_ShouldReturnOk_WhenBenefitIsRemoved() {
        ...
        // when
        ResponseEntity<String> response = packageBenefitsRelationsServiceImpl.removePackageBenefit(packageId, benefitId);
