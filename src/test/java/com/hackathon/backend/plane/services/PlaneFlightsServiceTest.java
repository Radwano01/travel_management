...
class PlaneFlightsServiceTest {
    ...
    void addFlight_ShouldReturnFlight_WhenFlightIsAdded() {
        ...
        // when
        ResponseEntity<String> response = planeFlightsService.addFlight(planeId, departureAirPortId, destinationAirPortId, flightDto);
    ...
    void getFlights_ShouldReturnFlights_WhenFlightsExist() {
        ...
        // when
        ResponseEntity<List<GetFlightDto>> response = planeFlightsService.getFlights(departureAirPortId, destinationAirPortId, page, size);
    ...
    void editFlight_ShouldReturnUpdatedFlight_WhenFlightIsEdited() {
        ...
        // when
        ResponseEntity<String> updatedFlight = planeFlightsService.editFlight(flightId, editFlightDto);
    ...
    void deleteFlight_ShouldReturnSuccess_WhenFlightIsDeleted() {
        ...
        // when
        ResponseEntity<String> response = planeFlightsService.deleteFlight(flightId);
    ...
    void removeFlights_ShouldRemovePastFlights() {
        ...
        // when
        planeFlightsService.removeFlights();
