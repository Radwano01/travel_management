...
class AirPortServiceImplTest {
    ...
    void createAirPort_ShouldReturnSuccess_WhenAirPortIsCreated() {
        ...
        // when
        ResponseEntity<String> response = airPortServiceImpl.createAirPort(placeId, airPortDto);
    ...
    void getAirPortsByPlaceId_ShouldReturnListOfAirPorts() {
        ...
        // when
        ResponseEntity<List<GetAirPortDto>> response = airPortServiceImpl.getAirPortsByPlaceId(placeId);
    ...
    void editAirPort_ShouldReturnUpdatedAirPortDetails() {
        ...
        // when
        ResponseEntity<String> response = airPortServiceImpl.editAirPort(placeId, airPortId, airPortDto);
    ...
    void deleteAirPort_ShouldReturnSuccess_WhenAirPortIsDeleted() {
        ...
        // when
        ResponseEntity<String> response = airPortServiceImpl.deleteAirPort(placeId, airPortId);
